...
#ifndef ASM330LHHX_TOW_DETECTION_H
#define ASM330LHHX_TOW_DETECTION_H
...
#define ASM330LHHX_TOW_DETECTION_SENSORS_NUM 1
...
static const char *const asm330lhhx_tow_detection_format_version = "2.0";

static const char *const asm330lhhx_tow_detection_description = NULL;

static const struct mems_conf_application asm330lhhx_tow_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const asm330lhhx_tow_detection_date = NULL;

/* Sensor names */

static const char *const asm330lhhx_tow_detection_names_0[] = {
    "ASM330LHHX"
};

static const struct mems_conf_name_list asm330lhhx_tow_detection_name_lists[ASM330LHHX_TOW_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhhx_tow_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhhx_tow_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op asm330lhhx_tow_detection_conf_0[] = {
...
static const struct mems_conf_op_list asm330lhhx_tow_detection_confs[ASM330LHHX_TOW_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhhx_tow_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(asm330lhhx_tow_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_result asm330lhhx_tow_detection_results_0_0[] = {
    { .code = 0x00, .label = "NoMotion" },
    { .code = 0x04, .label = "Towing" },
    { .code = 0x08, .label = "Towing2" }
};

static const struct mems_conf_result asm330lhhx_tow_detection_results_0_1[] = {
    { .code = 0x00, .label = "NoMotionY" },
    { .code = 0x04, .label = "TowingY" },
    { .code = 0x08, .label = "Towing2Y" }
};

static const struct mems_conf_result asm330lhhx_tow_detection_results_0_2[] = {
    { .code = 0x00, .label = "NoMotionZ" },
    { .code = 0x04, .label = "TowingZ" },
    { .code = 0x08, .label = "Towing2Z" }
};

static const struct mems_conf_output asm330lhhx_tow_detection_outputs_0[] = {
    {
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC0_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(asm330lhhx_tow_detection_results_0_0),
        .results = asm330lhhx_tow_detection_results_0_0
    },
    {
        ...
        .reg_addr = 0x71,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(asm330lhhx_tow_detection_results_0_1),
        .results = asm330lhhx_tow_detection_results_0_1
    },
    {
        ...
        .reg_addr = 0x72,
        .reg_name = "MLC2_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(asm330lhhx_tow_detection_results_0_2),
        .results = asm330lhhx_tow_detection_results_0_2
    }
};

static const struct mems_conf_output_list asm330lhhx_tow_detection_output_lists[ASM330LHHX_TOW_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhhx_tow_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhhx_tow_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list asm330lhhx_tow_detection_mlc_identifier_lists[ASM330LHHX_TOW_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ASM330LHHX_TOW_DETECTION_H */
