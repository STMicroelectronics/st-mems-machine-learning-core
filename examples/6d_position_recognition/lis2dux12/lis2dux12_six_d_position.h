...
#ifndef LIS2DUX12_SIX_D_POSITION_H
#define LIS2DUX12_SIX_D_POSITION_H
...
#define LIS2DUX12_SIX_D_POSITION_SENSORS_NUM 1
...
static const char *const lis2dux12_six_d_position_format_version = "2.0";

static const char *const lis2dux12_six_d_position_description = NULL;

static const struct mems_conf_application lis2dux12_six_d_position_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lis2dux12_six_d_position_date = NULL;

/* Sensor names */

static const char *const lis2dux12_six_d_position_names_0[] = {
    "lis2dux12"
};

static const struct mems_conf_name_list lis2dux12_six_d_position_name_lists[LIS2DUX12_SIX_D_POSITION_SENSORS_NUM] = {
    { .list = lis2dux12_six_d_position_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_six_d_position_names_0) }
};

/* Configurations */

static const struct mems_conf_op lis2dux12_six_d_position_conf_0[] = {
...
static const struct mems_conf_op_list lis2dux12_six_d_position_confs[LIS2DUX12_SIX_D_POSITION_SENSORS_NUM] = {
    { .list = lis2dux12_six_d_position_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lis2dux12_six_d_position_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lis2dux12_six_d_position_results_0_0[] = {
...
static const struct mems_conf_output lis2dux12_six_d_position_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x34,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lis2dux12_six_d_position_results_0_0),
        .results = lis2dux12_six_d_position_results_0_0
    }
};

static const struct mems_conf_output_list lis2dux12_six_d_position_output_lists[LIS2DUX12_SIX_D_POSITION_SENSORS_NUM] = {
    { .list = lis2dux12_six_d_position_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_six_d_position_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lis2dux12_six_d_position_mlc_identifiers_0[] = {
...
static const struct mems_conf_mlc_identifier_list lis2dux12_six_d_position_mlc_identifier_lists[LIS2DUX12_SIX_D_POSITION_SENSORS_NUM] = {
    { .list = lis2dux12_six_d_position_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_six_d_position_mlc_identifiers_0) }
};
...
#endif /* LIS2DUX12_SIX_D_POSITION_H */
