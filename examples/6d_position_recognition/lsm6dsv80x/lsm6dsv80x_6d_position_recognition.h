...
#ifndef LSM6DSV80X_6D_POSITION_RECOGNITION_H
#define LSM6DSV80X_6D_POSITION_RECOGNITION_H
...
#define LSM6DSV80X_6D_POSITION_RECOGNITION_SENSORS_NUM 1
...
static const char *const lsm6dsv80x_6d_position_recognition_format_version = "2.0";

static const char *const lsm6dsv80x_6d_position_recognition_description = NULL;

static const struct mems_conf_application lsm6dsv80x_6d_position_recognition_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsv80x_6d_position_recognition_date = NULL;

/* Sensor names */

static const char *const lsm6dsv80x_6d_position_recognition_names_0[] = {
    "LSM6DSV80X"
};

static const struct mems_conf_name_list lsm6dsv80x_6d_position_recognition_name_lists[LSM6DSV80X_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsv80x_6d_position_recognition_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv80x_6d_position_recognition_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv80x_6d_position_recognition_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsv80x_6d_position_recognition_confs[LSM6DSV80X_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsv80x_6d_position_recognition_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv80x_6d_position_recognition_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsv80x_6d_position_recognition_results_0_0[] = {
...
static const struct mems_conf_output lsm6dsv80x_6d_position_recognition_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsv80x_6d_position_recognition_results_0_0),
        .results = lsm6dsv80x_6d_position_recognition_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsv80x_6d_position_recognition_output_lists[LSM6DSV80X_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsv80x_6d_position_recognition_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv80x_6d_position_recognition_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsv80x_6d_position_recognition_mlc_identifiers_0[] = {
...
static const struct mems_conf_mlc_identifier_list lsm6dsv80x_6d_position_recognition_mlc_identifier_lists[LSM6DSV80X_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsv80x_6d_position_recognition_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv80x_6d_position_recognition_mlc_identifiers_0) }
};
...
#endif /* LSM6DSV80X_6D_POSITION_RECOGNITION_H */
