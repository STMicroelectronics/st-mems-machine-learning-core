...
#ifndef ST1VAFE3BX_6D_POSITION_RECOGNITION_H
#define ST1VAFE3BX_6D_POSITION_RECOGNITION_H
...
#define ST1VAFE3BX_6D_POSITION_RECOGNITION_SENSORS_NUM 1
...
static const char *const st1vafe3bx_6d_position_recognition_format_version = "2.0";

static const char *const st1vafe3bx_6d_position_recognition_description = NULL;

static const struct mems_conf_application st1vafe3bx_6d_position_recognition_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const st1vafe3bx_6d_position_recognition_date = NULL;

/* Sensor names */

static const char *const st1vafe3bx_6d_position_recognition_names_0[] = {
    "ST1VAFE3BX"
};

static const struct mems_conf_name_list st1vafe3bx_6d_position_recognition_name_lists[ST1VAFE3BX_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = st1vafe3bx_6d_position_recognition_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_6d_position_recognition_names_0) }
};

/* Configurations */

static const struct mems_conf_op st1vafe3bx_6d_position_recognition_conf_0[] = {
...
static const struct mems_conf_op_list st1vafe3bx_6d_position_recognition_confs[ST1VAFE3BX_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = st1vafe3bx_6d_position_recognition_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_6d_position_recognition_conf_0) }
};

/* Outputs */

static const struct mems_conf_result st1vafe3bx_6d_position_recognition_results_0_0[] = {
...
static const struct mems_conf_output st1vafe3bx_6d_position_recognition_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x34,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_6d_position_recognition_results_0_0),
        .results = st1vafe3bx_6d_position_recognition_results_0_0
    }
};

static const struct mems_conf_output_list st1vafe3bx_6d_position_recognition_output_lists[ST1VAFE3BX_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = st1vafe3bx_6d_position_recognition_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_6d_position_recognition_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier st1vafe3bx_6d_position_recognition_mlc_identifiers_0[] = {
...
static const struct mems_conf_mlc_identifier_list st1vafe3bx_6d_position_recognition_mlc_identifier_lists[ST1VAFE3BX_6D_POSITION_RECOGNITION_SENSORS_NUM] = {
    { .list = st1vafe3bx_6d_position_recognition_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_6d_position_recognition_mlc_identifiers_0) }
};
...
#endif /* ST1VAFE3BX_6D_POSITION_RECOGNITION_H */
