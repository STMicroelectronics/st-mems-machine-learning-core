...
#ifndef LSM6DSOX_SLEEP_DETECTION_H
#define LSM6DSOX_SLEEP_DETECTION_H
...
#define LSM6DSOX_SLEEP_DETECTION_SENSORS_NUM 1
...
static const char *const lsm6dsox_sleep_detection_format_version = "2.0";

static const char *const lsm6dsox_sleep_detection_description = "Generated sensor configuration for MLC core";

static const struct mems_conf_application lsm6dsox_sleep_detection_application = {
    .name = "MLC Tool",
    .version = "2.4.4"
};

static const char *const lsm6dsox_sleep_detection_date = "2026-04-09 17:07:23";

/* Sensor names */

static const char *const lsm6dsox_sleep_detection_names_0[] = {
    "LSM6DSOX"
};

static const struct mems_conf_name_list lsm6dsox_sleep_detection_name_lists[LSM6DSOX_SLEEP_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsox_sleep_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_sleep_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsox_sleep_detection_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x15, .data = 0x10 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x10, .data = 0x1C }
};

static const struct mems_conf_op_list lsm6dsox_sleep_detection_confs[LSM6DSOX_SLEEP_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsox_sleep_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_sleep_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsox_sleep_detection_results_0_0[] = {
    { .code = 0x00, .label = "awake" },
    { .code = 0x04, .label = "asleep" }
};

static const struct mems_conf_output lsm6dsox_sleep_detection_outputs_0[] = {
    {
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC0_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_sleep_detection_results_0_0),
        .results = lsm6dsox_sleep_detection_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsox_sleep_detection_output_lists[LSM6DSOX_SLEEP_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsox_sleep_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_sleep_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsox_sleep_detection_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1C, .id = 0x035C, .label = "F1_PEAK_TO_PEAK_ACC_X" },
    { .fifo_tag = 0x1C, .id = 0x035E, .label = "F2_PEAK_TO_PEAK_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x0360, .label = "F3_PEAK_TO_PEAK_ACC_Z" }
};

static const struct mems_conf_mlc_identifier_list lsm6dsox_sleep_detection_mlc_identifier_lists[LSM6DSOX_SLEEP_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsox_sleep_detection_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_sleep_detection_mlc_identifiers_0) }
};
...
#endif /* LSM6DSOX_SLEEP_DETECTION_H */
