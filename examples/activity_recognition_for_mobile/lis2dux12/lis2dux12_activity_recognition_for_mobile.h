...
#ifndef LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_H
#define LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_H
...
#define LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_SENSORS_NUM 1
...
static const char *const lis2dux12_activity_recognition_for_mobile_format_version = "2.0";

static const char *const lis2dux12_activity_recognition_for_mobile_description = NULL;

static const struct mems_conf_application lis2dux12_activity_recognition_for_mobile_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lis2dux12_activity_recognition_for_mobile_date = NULL;

/* Sensor names */

static const char *const lis2dux12_activity_recognition_for_mobile_names_0[] = {
    "LIS2DUX12"
};

static const struct mems_conf_name_list lis2dux12_activity_recognition_for_mobile_name_lists[LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_SENSORS_NUM] = {
    { .list = lis2dux12_activity_recognition_for_mobile_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_activity_recognition_for_mobile_names_0) }
};

/* Configurations */

static const struct mems_conf_op lis2dux12_activity_recognition_for_mobile_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xD7 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x22 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x97 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xBE },
...
static const struct mems_conf_op_list lis2dux12_activity_recognition_for_mobile_confs[LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_SENSORS_NUM] = {
    { .list = lis2dux12_activity_recognition_for_mobile_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lis2dux12_activity_recognition_for_mobile_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lis2dux12_activity_recognition_for_mobile_results_0_0[] = {
...
static const struct mems_conf_output lis2dux12_activity_recognition_for_mobile_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x34,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lis2dux12_activity_recognition_for_mobile_results_0_0),
        .results = lis2dux12_activity_recognition_for_mobile_results_0_0
    }
};

static const struct mems_conf_output_list lis2dux12_activity_recognition_for_mobile_output_lists[LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_SENSORS_NUM] = {
    { .list = lis2dux12_activity_recognition_for_mobile_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_activity_recognition_for_mobile_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lis2dux12_activity_recognition_for_mobile_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1B, .id = 0x01B2, .label = "FILTER_BP_ACC_V2" },
    { .fifo_tag = 0x1B, .id = 0x01B4, .label = "FILTER_IIR2_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01B6, .label = "F1_MEAN_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01B8, .label = "F2_VAR_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01BA, .label = "F3_VAR_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01BC, .label = "F4_VAR_on_filter_IIR2_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01BE, .label = "F5_ENERGY_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01C0, .label = "F6_ENERGY_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01C2, .label = "F7_ENERGY_on_filter_IIR2_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01C4, .label = "F8_PeakToPeak_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01C6, .label = "F9_PeakToPeak_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01C8, .label = "F10_PeakToPeak_on_filter_IIR2_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01CA, .label = "F11_ZeroCross_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01CC, .label = "F12_ZeroCross_on_filter_IIR2_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01CE, .label = "F13_PeaKDet_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01D0, .label = "F14_PeaKDet_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01D2, .label = "F15_PeaKDet_on_filter_IIR2_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01D4, .label = "F16_PosPeaKDet_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x01D6, .label = "F17_PosPeaKDet_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01D8, .label = "F18_PosPeaKDet_on_filter_IIR2_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01DA, .label = "F19_MIN_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x01DC, .label = "F20_MIN_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x01DE, .label = "F21_MAX_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x01E0, .label = "F22_MAX_on_filter_BP_on_A_V2" }
};

static const struct mems_conf_mlc_identifier_list lis2dux12_activity_recognition_for_mobile_mlc_identifier_lists[LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_SENSORS_NUM] = {
    { .list = lis2dux12_activity_recognition_for_mobile_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_activity_recognition_for_mobile_mlc_identifiers_0) }
};
...
#endif /* LIS2DUX12_ACTIVITY_RECOGNITION_FOR_MOBILE_H */
