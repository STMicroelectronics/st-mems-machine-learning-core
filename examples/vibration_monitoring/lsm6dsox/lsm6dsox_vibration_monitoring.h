...
#ifndef LSM6DSOX_VIBRATION_MONITORING_H
#define LSM6DSOX_VIBRATION_MONITORING_H
...
#define LSM6DSOX_VIBRATION_MONITORING_SENSORS_NUM 1
...
static const char *const lsm6dsox_vibration_monitoring_format_version = "2.0";

static const char *const lsm6dsox_vibration_monitoring_description = NULL;

static const struct mems_conf_application lsm6dsox_vibration_monitoring_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsox_vibration_monitoring_date = NULL;
...
static const struct mems_conf_name_list lsm6dsox_vibration_monitoring_name_lists[LSM6DSOX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = lsm6dsox_vibration_monitoring_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_vibration_monitoring_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsox_vibration_monitoring_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsox_vibration_monitoring_confs[LSM6DSOX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = lsm6dsox_vibration_monitoring_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_vibration_monitoring_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list lsm6dsox_vibration_monitoring_output_lists[LSM6DSOX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsox_vibration_monitoring_mlc_identifier_lists[LSM6DSOX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSOX_VIBRATION_MONITORING_H */
