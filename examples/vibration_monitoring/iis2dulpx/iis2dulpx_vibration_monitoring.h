...
#ifndef IIS2DULPX_VIBRATION_MONITORING_H
#define IIS2DULPX_VIBRATION_MONITORING_H
...
#define IIS2DULPX_VIBRATION_MONITORING_SENSORS_NUM 1
...
static const struct mems_conf_name_list iis2dulpx_vibration_monitoring_name_lists[IIS2DULPX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = iis2dulpx_vibration_monitoring_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_vibration_monitoring_names_0) }
};

/* Configurations */

static const struct mems_conf_op iis2dulpx_vibration_monitoring_conf_0[] = {
...
static const struct mems_conf_op_list iis2dulpx_vibration_monitoring_confs[IIS2DULPX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = iis2dulpx_vibration_monitoring_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_vibration_monitoring_conf_0) }
};

/* Outputs */

static const struct mems_conf_result iis2dulpx_vibration_monitoring_results_0_0[] = {
    { .code = 0x00, .label = "no_vibration" },
    { .code = 0x01, .label = "low_vibration" },
    { .code = 0x02, .label = "high_vibration" }
};

static const struct mems_conf_output iis2dulpx_vibration_monitoring_outputs_0[] = {
    {
        .name = "DT1",
...
static const struct mems_conf_output_list iis2dulpx_vibration_monitoring_output_lists[IIS2DULPX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = iis2dulpx_vibration_monitoring_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_vibration_monitoring_outputs_0) }
};
...
static const struct mems_conf_mlc_identifier_list iis2dulpx_vibration_monitoring_mlc_identifier_lists[IIS2DULPX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = iis2dulpx_vibration_monitoring_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_vibration_monitoring_mlc_identifiers_0) }
};
