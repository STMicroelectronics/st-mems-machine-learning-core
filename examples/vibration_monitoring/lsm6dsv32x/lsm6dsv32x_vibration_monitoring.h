...
#ifndef LSM6DSV32X_VIBRATION_MONITORING_H
#define LSM6DSV32X_VIBRATION_MONITORING_H
...
#define LSM6DSV32X_VIBRATION_MONITORING_SENSORS_NUM 1
...
static const char *const lsm6dsv32x_vibration_monitoring_format_version = "2.0";

static const char *const lsm6dsv32x_vibration_monitoring_description = NULL;

static const struct mems_conf_application lsm6dsv32x_vibration_monitoring_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsv32x_vibration_monitoring_date = NULL;

/* Sensor names */

static const char *const lsm6dsv32x_vibration_monitoring_names_0[] = {
    "LSM6DSV32X"
};

static const struct mems_conf_name_list lsm6dsv32x_vibration_monitoring_name_lists[LSM6DSV32X_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = lsm6dsv32x_vibration_monitoring_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_vibration_monitoring_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv32x_vibration_monitoring_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsv32x_vibration_monitoring_confs[LSM6DSV32X_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = lsm6dsv32x_vibration_monitoring_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_vibration_monitoring_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsv32x_vibration_monitoring_results_0_0[] = {
    { .code = 0x00, .label = "no_vibration" },
    { .code = 0x01, .label = "low_vibration" },
    { .code = 0x02, .label = "high_vibration" }
};

static const struct mems_conf_output lsm6dsv32x_vibration_monitoring_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_vibration_monitoring_results_0_0),
        .results = lsm6dsv32x_vibration_monitoring_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsv32x_vibration_monitoring_output_lists[LSM6DSV32X_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = lsm6dsv32x_vibration_monitoring_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_vibration_monitoring_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsv32x_vibration_monitoring_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1C, .id = 0x0370, .label = "F1_ABS_PeakToPeak_on_ACC_V2" }
};

static const struct mems_conf_mlc_identifier_list lsm6dsv32x_vibration_monitoring_mlc_identifier_lists[LSM6DSV32X_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = lsm6dsv32x_vibration_monitoring_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_vibration_monitoring_mlc_identifiers_0) }
};
...
#endif /* LSM6DSV32X_VIBRATION_MONITORING_H */
