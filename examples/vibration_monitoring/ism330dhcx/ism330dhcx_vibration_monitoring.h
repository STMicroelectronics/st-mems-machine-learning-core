...
#define ISM330DHCX_VIBRATION_MONITORING_SENSORS_NUM 1
...
static const char *const ism330dhcx_vibration_monitoring_format_version = "2.0";

static const char *const ism330dhcx_vibration_monitoring_description = NULL;

static const struct mems_conf_application ism330dhcx_vibration_monitoring_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const ism330dhcx_vibration_monitoring_date = NULL;

/* Sensor names */

static const char *const ism330dhcx_vibration_monitoring_names_0[] = {
    "ism330dhcx"
};

static const struct mems_conf_name_list ism330dhcx_vibration_monitoring_name_lists[ISM330DHCX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = ism330dhcx_vibration_monitoring_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism330dhcx_vibration_monitoring_names_0) }
};

/* Configurations */

static const struct mems_conf_op ism330dhcx_vibration_monitoring_conf_0[] = {
...
static const struct mems_conf_op_list ism330dhcx_vibration_monitoring_confs[ISM330DHCX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = ism330dhcx_vibration_monitoring_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(ism330dhcx_vibration_monitoring_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list ism330dhcx_vibration_monitoring_output_lists[ISM330DHCX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list ism330dhcx_vibration_monitoring_mlc_identifier_lists[ISM330DHCX_VIBRATION_MONITORING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
