...
#ifndef LSM6DSOX_YOGA_POSE_RECOGNITION_H
#define LSM6DSOX_YOGA_POSE_RECOGNITION_H
...
#define LSM6DSOX_YOGA_POSE_RECOGNITION_SENSORS_NUM 1
...
static const char *const lsm6dsox_yoga_pose_recognition_format_version = "2.0";

static const char *const lsm6dsox_yoga_pose_recognition_description = NULL;

static const struct mems_conf_application lsm6dsox_yoga_pose_recognition_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsox_yoga_pose_recognition_date = NULL;
...
static const struct mems_conf_name_list lsm6dsox_yoga_pose_recognition_name_lists[LSM6DSOX_YOGA_POSE_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsox_yoga_pose_recognition_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_yoga_pose_recognition_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsox_yoga_pose_recognition_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x9B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xE2 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x9C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x72 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x9D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xBA },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x9E },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x12 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x9F },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x82 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA0 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x93 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA1 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xA3 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA2 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x11 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA3 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x80 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA4 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xD5 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA5 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xAF },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB1 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x39 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB2 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x14 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB3 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x82 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB4 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xEA },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB5 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB7 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xE0 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB8 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xA6 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB9 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xBA },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x80 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xBB },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xA2 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xBC },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x12 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xBD },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xB5 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xBE },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xBF },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xE0 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x80 },
...
static const struct mems_conf_op_list lsm6dsox_yoga_pose_recognition_confs[LSM6DSOX_YOGA_POSE_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsox_yoga_pose_recognition_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_yoga_pose_recognition_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsox_yoga_pose_recognition_results_0_0[] = {
...
static const struct mems_conf_output lsm6dsox_yoga_pose_recognition_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC0_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_yoga_pose_recognition_results_0_0),
        .results = lsm6dsox_yoga_pose_recognition_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsox_yoga_pose_recognition_output_lists[LSM6DSOX_YOGA_POSE_RECOGNITION_SENSORS_NUM] = {
    { .list = lsm6dsox_yoga_pose_recognition_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_yoga_pose_recognition_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsox_yoga_pose_recognition_mlc_identifier_lists[LSM6DSOX_YOGA_POSE_RECOGNITION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSOX_YOGA_POSE_RECOGNITION_H */
