...
#ifndef ISM6HGK256X_NAIL_GUN_DETECTION_H
#define ISM6HGK256X_NAIL_GUN_DETECTION_H
...
#define ISM6HGK256X_NAIL_GUN_DETECTION_SENSORS_NUM 1
...
static const char *const ism6hgk256x_nail_gun_detection_format_version = "2.0";

static const char *const ism6hgk256x_nail_gun_detection_description = "Generated sensor configuration for MLC core";

static const struct mems_conf_application ism6hgk256x_nail_gun_detection_application = {
    .name = "MLC Tool",
    .version = "2.4.4"
};

static const char *const ism6hgk256x_nail_gun_detection_date = "2026-03-27 08:54:24";

/* Sensor names */

static const char *const ism6hgk256x_nail_gun_detection_names_0[] = {
    "ISM6HGK256X"
};

static const struct mems_conf_name_list ism6hgk256x_nail_gun_detection_name_lists[ISM6HGK256X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = ism6hgk256x_nail_gun_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hgk256x_nail_gun_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op ism6hgk256x_nail_gun_detection_conf_0[] = {
...
static const struct mems_conf_op_list ism6hgk256x_nail_gun_detection_confs[ISM6HGK256X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = ism6hgk256x_nail_gun_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(ism6hgk256x_nail_gun_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_result ism6hgk256x_nail_gun_detection_results_0_0[] = {
    { .code = 0x01, .label = "stationary" },
    { .code = 0x04, .label = "use" },
    { .code = 0x08, .label = "nail" }
};

static const struct mems_conf_output ism6hgk256x_nail_gun_detection_outputs_0[] = {
    {
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(ism6hgk256x_nail_gun_detection_results_0_0),
        .results = ism6hgk256x_nail_gun_detection_results_0_0
    }
};

static const struct mems_conf_output_list ism6hgk256x_nail_gun_detection_output_lists[ISM6HGK256X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = ism6hgk256x_nail_gun_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hgk256x_nail_gun_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier ism6hgk256x_nail_gun_detection_mlc_identifiers_0[] = {
...
static const struct mems_conf_mlc_identifier_list ism6hgk256x_nail_gun_detection_mlc_identifier_lists[ISM6HGK256X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = ism6hgk256x_nail_gun_detection_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hgk256x_nail_gun_detection_mlc_identifiers_0) }
};
...
#endif /* ISM6HGK256X_NAIL_GUN_DETECTION_H */
