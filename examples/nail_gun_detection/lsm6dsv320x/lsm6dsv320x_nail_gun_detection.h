...
#ifndef LSM6DSV320X_NAIL_GUN_DETECTION_H
#define LSM6DSV320X_NAIL_GUN_DETECTION_H
...
#define LSM6DSV320X_NAIL_GUN_DETECTION_SENSORS_NUM 1
...
static const char *const lsm6dsv320x_nail_gun_detection_format_version = "2.0";

static const char *const lsm6dsv320x_nail_gun_detection_description = "Generated sensor configuration for MLC core";

static const struct mems_conf_application lsm6dsv320x_nail_gun_detection_application = {
    .name = "MLC Tool",
    .version = "2.4.4"
};

static const char *const lsm6dsv320x_nail_gun_detection_date = "2026-03-27 08:53:58";

/* Sensor names */

static const char *const lsm6dsv320x_nail_gun_detection_names_0[] = {
    "LSM6DSV320X"
};

static const struct mems_conf_name_list lsm6dsv320x_nail_gun_detection_name_lists[LSM6DSV320X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsv320x_nail_gun_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_nail_gun_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv320x_nail_gun_detection_conf_0[] = {
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x10, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x4E, .data = 0x00 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x60, .data = 0x65 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x45, .data = 0x02 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x10, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x15, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x17, .data = 0x03 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x4E, .data = 0xA4 }
};

static const struct mems_conf_op_list lsm6dsv320x_nail_gun_detection_confs[LSM6DSV320X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsv320x_nail_gun_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_nail_gun_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsv320x_nail_gun_detection_results_0_0[] = {
    { .code = 0x01, .label = "stationary" },
    { .code = 0x04, .label = "use" },
    { .code = 0x08, .label = "nail" }
};

static const struct mems_conf_output lsm6dsv320x_nail_gun_detection_outputs_0[] = {
    {
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_nail_gun_detection_results_0_0),
        .results = lsm6dsv320x_nail_gun_detection_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsv320x_nail_gun_detection_output_lists[LSM6DSV320X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsv320x_nail_gun_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_nail_gun_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsv320x_nail_gun_detection_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1B, .id = 0x0384, .label = "FILTER_HP_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x0386, .label = "F1_VARIANCE_ACC_V_FILTER_1" },
    { .fifo_tag = 0x1C, .id = 0x0388, .label = "F2_PEAK_TO_PEAK_ACCHG_V" }
};

static const struct mems_conf_mlc_identifier_list lsm6dsv320x_nail_gun_detection_mlc_identifier_lists[LSM6DSV320X_NAIL_GUN_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsv320x_nail_gun_detection_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_nail_gun_detection_mlc_identifiers_0) }
};
...
#endif /* LSM6DSV320X_NAIL_GUN_DETECTION_H */
