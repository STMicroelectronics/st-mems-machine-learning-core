...
#ifndef LSM6DSOX_ASSET_TRACKING_H
#define LSM6DSOX_ASSET_TRACKING_H
...
#define LSM6DSOX_ASSET_TRACKING_SENSORS_NUM 1
...
static const char *const lsm6dsox_asset_tracking_format_version = "2.0";

static const char *const lsm6dsox_asset_tracking_description = NULL;

static const struct mems_conf_application lsm6dsox_asset_tracking_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsox_asset_tracking_date = NULL;

/* Sensor names */

static const char *const lsm6dsox_asset_tracking_names_0[] = {
    "lsm6dsox"
};

static const struct mems_conf_name_list lsm6dsox_asset_tracking_name_lists[LSM6DSOX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lsm6dsox_asset_tracking_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_asset_tracking_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsox_asset_tracking_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x10, .data = 0x24 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x5E, .data = 0x02 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x80 },
...
static const struct mems_conf_op_list lsm6dsox_asset_tracking_confs[LSM6DSOX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lsm6dsox_asset_tracking_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_asset_tracking_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list lsm6dsox_asset_tracking_output_lists[LSM6DSOX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsox_asset_tracking_mlc_identifier_lists[LSM6DSOX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSOX_ASSET_TRACKING_H */
