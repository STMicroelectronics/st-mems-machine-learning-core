...
#define LSM6DSRX_ASSET_TRACKING_SENSORS_NUM 1
...
static const char *const lsm6dsrx_asset_tracking_format_version = "2.0";

static const char *const lsm6dsrx_asset_tracking_description = NULL;

static const struct mems_conf_application lsm6dsrx_asset_tracking_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsrx_asset_tracking_date = NULL;

/* Sensor names */

static const char *const lsm6dsrx_asset_tracking_names_0[] = {
    "LSM6DSRX"
};

static const struct mems_conf_name_list lsm6dsrx_asset_tracking_name_lists[LSM6DSRX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lsm6dsrx_asset_tracking_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_asset_tracking_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsrx_asset_tracking_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsrx_asset_tracking_confs[LSM6DSRX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lsm6dsrx_asset_tracking_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_asset_tracking_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list lsm6dsrx_asset_tracking_output_lists[LSM6DSRX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsrx_asset_tracking_mlc_identifier_lists[LSM6DSRX_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
