...
#ifndef LIS2DUXS12_ASSET_TRACKING_H
#define LIS2DUXS12_ASSET_TRACKING_H
...
#define LIS2DUXS12_ASSET_TRACKING_SENSORS_NUM 1
...
static const char *const lis2duxs12_asset_tracking_format_version = "2.0";

static const char *const lis2duxs12_asset_tracking_description = NULL;

static const struct mems_conf_application lis2duxs12_asset_tracking_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lis2duxs12_asset_tracking_date = NULL;

/* Sensor names */

static const char *const lis2duxs12_asset_tracking_names_0[] = {
    "LIS2DUXS12"
};

static const struct mems_conf_name_list lis2duxs12_asset_tracking_name_lists[LIS2DUXS12_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lis2duxs12_asset_tracking_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2duxs12_asset_tracking_names_0) }
};

/* Configurations */

static const struct mems_conf_op lis2duxs12_asset_tracking_conf_0[] = {
...
static const struct mems_conf_op_list lis2duxs12_asset_tracking_confs[LIS2DUXS12_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lis2duxs12_asset_tracking_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lis2duxs12_asset_tracking_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lis2duxs12_asset_tracking_results_0_8[] = {
    { .code = 0x00, .label = "0" },
    { .code = 0x04, .label = "4" },
    { .code = 0x08, .label = "8" },
    { .code = 0x0C, .label = "12" }
...
static const struct mems_conf_output lis2duxs12_asset_tracking_outputs_0[] = {
    {
        .name = "FSM1",
    ...
    },
    {
        ...
        .reg_addr = 0x34,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lis2duxs12_asset_tracking_results_0_8),
        .results = lis2duxs12_asset_tracking_results_0_8
    }
};

static const struct mems_conf_output_list lis2duxs12_asset_tracking_output_lists[LIS2DUXS12_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = lis2duxs12_asset_tracking_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2duxs12_asset_tracking_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lis2duxs12_asset_tracking_mlc_identifier_lists[LIS2DUXS12_ASSET_TRACKING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LIS2DUXS12_ASSET_TRACKING_H */
