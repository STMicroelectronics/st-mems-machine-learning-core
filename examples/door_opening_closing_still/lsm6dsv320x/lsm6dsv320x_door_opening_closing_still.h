...
#ifndef LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_H
#define LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_H
...
#define LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_SENSORS_NUM 1
...
static const char *const lsm6dsv320x_door_opening_closing_still_format_version = "2.0";

static const char *const lsm6dsv320x_door_opening_closing_still_description = NULL;

static const struct mems_conf_application lsm6dsv320x_door_opening_closing_still_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsv320x_door_opening_closing_still_date = NULL;

/* Sensor names */

static const char *const lsm6dsv320x_door_opening_closing_still_names_0[] = {
    "LSM6DSV320X"
};

static const struct mems_conf_name_list lsm6dsv320x_door_opening_closing_still_name_lists[LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_SENSORS_NUM] = {
    { .list = lsm6dsv320x_door_opening_closing_still_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_door_opening_closing_still_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv320x_door_opening_closing_still_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x15, .data = 0x01 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x17, .data = 0x01 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x10, .data = 0x05 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x05 }
};

static const struct mems_conf_op_list lsm6dsv320x_door_opening_closing_still_confs[LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_SENSORS_NUM] = {
    { .list = lsm6dsv320x_door_opening_closing_still_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_door_opening_closing_still_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsv320x_door_opening_closing_still_results_0_0[] = {
    { .code = 0x00, .label = "close" },
    { .code = 0x04, .label = "open" },
    { .code = 0x08, .label = "still" }
};

static const struct mems_conf_output lsm6dsv320x_door_opening_closing_still_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_door_opening_closing_still_results_0_0),
        .results = lsm6dsv320x_door_opening_closing_still_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsv320x_door_opening_closing_still_output_lists[LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_SENSORS_NUM] = {
    { .list = lsm6dsv320x_door_opening_closing_still_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_door_opening_closing_still_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsv320x_door_opening_closing_still_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1C, .id = 0x0230, .label = "F1_MEAN_on_GY_X" }
};

static const struct mems_conf_mlc_identifier_list lsm6dsv320x_door_opening_closing_still_mlc_identifier_lists[LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_SENSORS_NUM] = {
    { .list = lsm6dsv320x_door_opening_closing_still_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv320x_door_opening_closing_still_mlc_identifiers_0) }
};
...
#endif /* LSM6DSV320X_DOOR_OPENING_CLOSING_STILL_H */
