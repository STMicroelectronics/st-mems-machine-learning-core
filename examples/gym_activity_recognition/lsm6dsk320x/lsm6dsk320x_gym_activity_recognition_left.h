...
#ifndef LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_H
#define LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_H
...
#define LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_SENSORS_NUM 1
...
static const char *const lsm6dsk320x_gym_activity_recognition_left_format_version = "2.0";

static const char *const lsm6dsk320x_gym_activity_recognition_left_description = NULL;

static const struct mems_conf_application lsm6dsk320x_gym_activity_recognition_left_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsk320x_gym_activity_recognition_left_date = NULL;

/* Sensor names */

static const char *const lsm6dsk320x_gym_activity_recognition_left_names_0[] = {
    "LSM6DSK320X"
};

static const struct mems_conf_name_list lsm6dsk320x_gym_activity_recognition_left_name_lists[LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_SENSORS_NUM] = {
    { .list = lsm6dsk320x_gym_activity_recognition_left_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_gym_activity_recognition_left_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsk320x_gym_activity_recognition_left_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsk320x_gym_activity_recognition_left_confs[LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_SENSORS_NUM] = {
    { .list = lsm6dsk320x_gym_activity_recognition_left_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_gym_activity_recognition_left_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsk320x_gym_activity_recognition_left_results_0_0[] = {
...
static const struct mems_conf_output lsm6dsk320x_gym_activity_recognition_left_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_gym_activity_recognition_left_results_0_0),
        .results = lsm6dsk320x_gym_activity_recognition_left_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsk320x_gym_activity_recognition_left_output_lists[LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_SENSORS_NUM] = {
    { .list = lsm6dsk320x_gym_activity_recognition_left_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_gym_activity_recognition_left_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsk320x_gym_activity_recognition_left_mlc_identifier_lists[LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSK320X_GYM_ACTIVITY_RECOGNITION_LEFT_H */
