...
#ifndef TENNIS_DSV320X_MLC_CONF_H
#define TENNIS_DSV320X_MLC_CONF_H
...
#define TENNIS_DSV320X_MLC_CONF_SENSORS_NUM 1
...
static const char *const tennis_dsv320x_mlc_conf_format_version = "2.0";

static const char *const tennis_dsv320x_mlc_conf_description = "Generated sensor configuration for MLC core";

static const struct mems_conf_application tennis_dsv320x_mlc_conf_application = {
    .name = "MLC Tool",
    .version = "2.3.0"
};
...
static const char *const tennis_dsv320x_mlc_conf_names_0[] = {
    "LSM6DSV320X"
};

static const struct mems_conf_name_list tennis_dsv320x_mlc_conf_name_lists[TENNIS_DSV320X_MLC_CONF_SENSORS_NUM] = {
    { .list = tennis_dsv320x_mlc_conf_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(tennis_dsv320x_mlc_conf_names_0) }
};

/* Configurations */

static const struct mems_conf_op tennis_dsv320x_mlc_conf_conf_0[] = {
...
static const struct mems_conf_op_list tennis_dsv320x_mlc_conf_confs[TENNIS_DSV320X_MLC_CONF_SENSORS_NUM] = {
    { .list = tennis_dsv320x_mlc_conf_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(tennis_dsv320x_mlc_conf_conf_0) }
};

/* Outputs */

static const struct mems_conf_result tennis_dsv320x_mlc_conf_results_0_0[] = {
...
static const struct mems_conf_output tennis_dsv320x_mlc_conf_outputs_0[] = {
    {
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(tennis_dsv320x_mlc_conf_results_0_0),
        .results = tennis_dsv320x_mlc_conf_results_0_0
    }
};

static const struct mems_conf_output_list tennis_dsv320x_mlc_conf_output_lists[TENNIS_DSV320X_MLC_CONF_SENSORS_NUM] = {
    { .list = tennis_dsv320x_mlc_conf_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(tennis_dsv320x_mlc_conf_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier tennis_dsv320x_mlc_conf_mlc_identifiers_0[] = {
...
static const struct mems_conf_mlc_identifier_list tennis_dsv320x_mlc_conf_mlc_identifier_lists[TENNIS_DSV320X_MLC_CONF_SENSORS_NUM] = {
    { .list = tennis_dsv320x_mlc_conf_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(tennis_dsv320x_mlc_conf_mlc_identifiers_0) }
};
...
#endif /* TENNIS_DSV320X_MLC_CONF_H */
