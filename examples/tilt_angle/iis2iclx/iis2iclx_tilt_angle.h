...
#ifndef IIS2ICLX_TILT_ANGLE_H
#define IIS2ICLX_TILT_ANGLE_H
...
#define IIS2ICLX_TILT_ANGLE_SENSORS_NUM 1
...
static const char *const iis2iclx_tilt_angle_format_version = "2.0";

static const char *const iis2iclx_tilt_angle_description = NULL;

static const struct mems_conf_application iis2iclx_tilt_angle_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const iis2iclx_tilt_angle_date = NULL;

/* Sensor names */

static const char *const iis2iclx_tilt_angle_names_0[] = {
    "IIS2ICLX"
};

static const struct mems_conf_name_list iis2iclx_tilt_angle_name_lists[IIS2ICLX_TILT_ANGLE_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_angle_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_angle_names_0) }
};

/* Configurations */

static const struct mems_conf_op iis2iclx_tilt_angle_conf_0[] = {
...
static const struct mems_conf_op_list iis2iclx_tilt_angle_confs[IIS2ICLX_TILT_ANGLE_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_angle_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_angle_conf_0) }
};

/* Outputs */

static const struct mems_conf_result iis2iclx_tilt_angle_results_0_0[] = {
    { .code = 0x00, .label = "0" },
    { .code = 0x01, .label = "1" },
    { .code = 0x02, .label = "2" },
    { .code = 0x03, .label = "3" },
...
static const struct mems_conf_result iis2iclx_tilt_angle_results_0_1[] = {
    { .code = 0x00, .label = "0" },
    { .code = 0x01, .label = "1" },
    { .code = 0x02, .label = "2" },
    { .code = 0x03, .label = "3" },
...
static const struct mems_conf_output iis2iclx_tilt_angle_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC0_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_angle_results_0_0),
        .results = iis2iclx_tilt_angle_results_0_0
    },
    {
        .name = "DT2",
        .core = MEMS_CONF_OUTPUT_CORE_MLC,
        ...
        .reg_addr = 0x71,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_angle_results_0_1),
        .results = iis2iclx_tilt_angle_results_0_1
    }
};

static const struct mems_conf_output_list iis2iclx_tilt_angle_output_lists[IIS2ICLX_TILT_ANGLE_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_angle_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_angle_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list iis2iclx_tilt_angle_mlc_identifier_lists[IIS2ICLX_TILT_ANGLE_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
