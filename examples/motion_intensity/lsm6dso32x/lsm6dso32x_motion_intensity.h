...
#ifndef LSM6DSO32X_MOTION_INTENSITY_H
#define LSM6DSO32X_MOTION_INTENSITY_H
...
#define LSM6DSO32X_MOTION_INTENSITY_SENSORS_NUM 1
...
static const char *const lsm6dso32x_motion_intensity_format_version = "2.0";

static const char *const lsm6dso32x_motion_intensity_description = NULL;

static const struct mems_conf_application lsm6dso32x_motion_intensity_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dso32x_motion_intensity_date = NULL;

/* Sensor names */

static const char *const lsm6dso32x_motion_intensity_names_0[] = {
    "lsm6dso32x"
};

static const struct mems_conf_name_list lsm6dso32x_motion_intensity_name_lists[LSM6DSO32X_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = lsm6dso32x_motion_intensity_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_motion_intensity_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dso32x_motion_intensity_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dso32x_motion_intensity_confs[LSM6DSO32X_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = lsm6dso32x_motion_intensity_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_motion_intensity_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dso32x_motion_intensity_results_0_0[] = {
...
static const struct mems_conf_output lsm6dso32x_motion_intensity_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC0_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_motion_intensity_results_0_0),
        .results = lsm6dso32x_motion_intensity_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dso32x_motion_intensity_output_lists[LSM6DSO32X_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = lsm6dso32x_motion_intensity_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_motion_intensity_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dso32x_motion_intensity_mlc_identifier_lists[LSM6DSO32X_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSO32X_MOTION_INTENSITY_H */
