...
#ifndef ST1VAFE6AX_MOTION_INTENSITY_H
#define ST1VAFE6AX_MOTION_INTENSITY_H
...
#define ST1VAFE6AX_MOTION_INTENSITY_SENSORS_NUM 1
...
static const char *const st1vafe6ax_motion_intensity_format_version = "2.0";

static const char *const st1vafe6ax_motion_intensity_description = NULL;

static const struct mems_conf_application st1vafe6ax_motion_intensity_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const st1vafe6ax_motion_intensity_date = NULL;

/* Sensor names */

static const char *const st1vafe6ax_motion_intensity_names_0[] = {
    "st1vafe6ax"
};

static const struct mems_conf_name_list st1vafe6ax_motion_intensity_name_lists[ST1VAFE6AX_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = st1vafe6ax_motion_intensity_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_motion_intensity_names_0) }
};

/* Configurations */

static const struct mems_conf_op st1vafe6ax_motion_intensity_conf_0[] = {
...
static const struct mems_conf_op_list st1vafe6ax_motion_intensity_confs[ST1VAFE6AX_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = st1vafe6ax_motion_intensity_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_motion_intensity_conf_0) }
};

/* Outputs */

static const struct mems_conf_result st1vafe6ax_motion_intensity_results_0_0[] = {
...
static const struct mems_conf_output st1vafe6ax_motion_intensity_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_motion_intensity_results_0_0),
        .results = st1vafe6ax_motion_intensity_results_0_0
    }
};

static const struct mems_conf_output_list st1vafe6ax_motion_intensity_output_lists[ST1VAFE6AX_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = st1vafe6ax_motion_intensity_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_motion_intensity_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier st1vafe6ax_motion_intensity_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1C, .id = 0x0370, .label = "F1_VAR_on_ACC_V" }
};

static const struct mems_conf_mlc_identifier_list st1vafe6ax_motion_intensity_mlc_identifier_lists[ST1VAFE6AX_MOTION_INTENSITY_SENSORS_NUM] = {
    { .list = st1vafe6ax_motion_intensity_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_motion_intensity_mlc_identifiers_0) }
};
...
#endif /* ST1VAFE6AX_MOTION_INTENSITY_H */
