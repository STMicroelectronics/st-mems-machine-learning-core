...
#ifndef LSM6DSV32X_HEAD_GESTURES_H
#define LSM6DSV32X_HEAD_GESTURES_H
...
#define LSM6DSV32X_HEAD_GESTURES_SENSORS_NUM 1
...
static const char *const lsm6dsv32x_head_gestures_format_version = "2.0";

static const char *const lsm6dsv32x_head_gestures_description = NULL;

static const struct mems_conf_application lsm6dsv32x_head_gestures_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsv32x_head_gestures_date = NULL;

/* Sensor names */

static const char *const lsm6dsv32x_head_gestures_names_0[] = {
    "LSM6DSV32X"
};

static const struct mems_conf_name_list lsm6dsv32x_head_gestures_name_lists[LSM6DSV32X_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = lsm6dsv32x_head_gestures_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_head_gestures_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv32x_head_gestures_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x54 }
};

static const struct mems_conf_op_list lsm6dsv32x_head_gestures_confs[LSM6DSV32X_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = lsm6dsv32x_head_gestures_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_head_gestures_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsv32x_head_gestures_results_0_0[] = {
    { .code = 0x00, .label = "other" },
    { .code = 0x04, .label = "nod" },
    { .code = 0x08, .label = "shake" }
};

static const struct mems_conf_output lsm6dsv32x_head_gestures_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_head_gestures_results_0_0),
        .results = lsm6dsv32x_head_gestures_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsv32x_head_gestures_output_lists[LSM6DSV32X_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = lsm6dsv32x_head_gestures_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv32x_head_gestures_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsv32x_head_gestures_mlc_identifier_lists[LSM6DSV32X_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSV32X_HEAD_GESTURES_H */
