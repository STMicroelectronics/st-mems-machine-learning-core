...
#ifndef LSM6DSRX_HEAD_GESTURES_H
#define LSM6DSRX_HEAD_GESTURES_H
...
#define LSM6DSRX_HEAD_GESTURES_SENSORS_NUM 1
...
static const char *const lsm6dsrx_head_gestures_format_version = "2.0";

static const char *const lsm6dsrx_head_gestures_description = NULL;

static const struct mems_conf_application lsm6dsrx_head_gestures_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsrx_head_gestures_date = NULL;

/* Sensor names */

static const char *const lsm6dsrx_head_gestures_names_0[] = {
    "LSM6DSRX"
};

static const struct mems_conf_name_list lsm6dsrx_head_gestures_name_lists[LSM6DSRX_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = lsm6dsrx_head_gestures_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_head_gestures_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsrx_head_gestures_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x03 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x5D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x08 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x5E },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x5F },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xFC },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x60 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x61 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x7C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x62 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x03 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x63 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x1C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x64 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x65 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xFC },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x66 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x67 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x7C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x68 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x10 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x69 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x18 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x6A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x6B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xFC },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x6C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x6D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x7C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x79 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x7C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA6 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA7 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA8 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xA9 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xAA },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xAB },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xAC },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xAD },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xAE },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xAF },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xB0 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x01 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x03 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x02 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x04 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x1C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x05 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x08 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x06 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x07 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x08 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xCE },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x47 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x0A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x03 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x0B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x04 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x0C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x10 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x0D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x0E },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x0F },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x10 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x11 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x12 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x13 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x06 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x14 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x15 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x16 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x17 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x18 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xC6 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x19 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x1A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x04 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x1B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x04 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x1C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x24 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x1D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x1E },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x1F },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x20 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x2D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x21 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x22 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x04 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x23 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x24 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x24 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x25 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x26 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x27 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x28 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xAB },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x29 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3E },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x2A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x01 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x2B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x08 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x2C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x1C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x2D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x2E },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x2F },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x30 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xE4 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x31 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x51 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x32 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x03 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x33 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x02 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x34 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x10 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x35 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x36 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x37 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x80 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x20 },
...
static const struct mems_conf_op_list lsm6dsrx_head_gestures_confs[LSM6DSRX_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = lsm6dsrx_head_gestures_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_head_gestures_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list lsm6dsrx_head_gestures_output_lists[LSM6DSRX_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsrx_head_gestures_mlc_identifier_lists[LSM6DSRX_HEAD_GESTURES_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSRX_HEAD_GESTURES_H */
