...
#ifndef ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_H
#define ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_H
...
#define ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM 1
...
static const char *const st1vafe3bx_activity_recognition_for_wrist_format_version = "2.0";

static const char *const st1vafe3bx_activity_recognition_for_wrist_description = NULL;

static const struct mems_conf_application st1vafe3bx_activity_recognition_for_wrist_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const st1vafe3bx_activity_recognition_for_wrist_date = NULL;

/* Sensor names */

static const char *const st1vafe3bx_activity_recognition_for_wrist_names_0[] = {
    "ST1VAFE3BX"
};

static const struct mems_conf_name_list st1vafe3bx_activity_recognition_for_wrist_name_lists[ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = st1vafe3bx_activity_recognition_for_wrist_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_activity_recognition_for_wrist_names_0) }
};

/* Configurations */

static const struct mems_conf_op st1vafe3bx_activity_recognition_for_wrist_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x3F, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x14, .data = 0x62 }
};

static const struct mems_conf_op_list st1vafe3bx_activity_recognition_for_wrist_confs[ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = st1vafe3bx_activity_recognition_for_wrist_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_activity_recognition_for_wrist_conf_0) }
};

/* Outputs */

static const struct mems_conf_result st1vafe3bx_activity_recognition_for_wrist_results_0_0[] = {
    { .code = 0x01, .label = "other_wrist" },
    { .code = 0x04, .label = "walk_wrist" },
    { .code = 0x08, .label = "run_wrist" }
};

static const struct mems_conf_output st1vafe3bx_activity_recognition_for_wrist_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x34,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_activity_recognition_for_wrist_results_0_0),
        .results = st1vafe3bx_activity_recognition_for_wrist_results_0_0
    }
};

static const struct mems_conf_output_list st1vafe3bx_activity_recognition_for_wrist_output_lists[ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = st1vafe3bx_activity_recognition_for_wrist_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_activity_recognition_for_wrist_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier st1vafe3bx_activity_recognition_for_wrist_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1B, .id = 0x015E, .label = "FILTER_BP_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x0160, .label = "F1_VAR_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x0162, .label = "F2_VAR_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x0164, .label = "F3_ENERGY_on_ACC_V2" },
    { .fifo_tag = 0x1C, .id = 0x0166, .label = "F4_ENERGY_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x0168, .label = "F5_PeakToPeak_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x016A, .label = "F6_PeakToPeak_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x016C, .label = "F7_ZeroCross_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x016E, .label = "F8_ZeroCross_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x0170, .label = "F9_PeaKDet_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x0172, .label = "F10_PeaKDet_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x0174, .label = "F11_MIN_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x0176, .label = "F12_MIN_on_filter_BP_on_A_V2" },
    { .fifo_tag = 0x1C, .id = 0x0178, .label = "F13_MAX_on_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x017A, .label = "F14_MAX_on_filter_BP_on_A_V2" }
};

static const struct mems_conf_mlc_identifier_list st1vafe3bx_activity_recognition_for_wrist_mlc_identifier_lists[ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = st1vafe3bx_activity_recognition_for_wrist_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe3bx_activity_recognition_for_wrist_mlc_identifiers_0) }
};
...
#endif /* ST1VAFE3BX_ACTIVITY_RECOGNITION_FOR_WRIST_H */
