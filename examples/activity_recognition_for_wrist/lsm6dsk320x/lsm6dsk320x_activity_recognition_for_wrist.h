...
#ifndef LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_H
#define LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_H
...
#define LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM 1
...
static const char *const lsm6dsk320x_activity_recognition_for_wrist_format_version = "2.0";

static const char *const lsm6dsk320x_activity_recognition_for_wrist_description = NULL;

static const struct mems_conf_application lsm6dsk320x_activity_recognition_for_wrist_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsk320x_activity_recognition_for_wrist_date = NULL;

/* Sensor names */

static const char *const lsm6dsk320x_activity_recognition_for_wrist_names_0[] = {
    "LSM6DSK320X"
};

static const struct mems_conf_name_list lsm6dsk320x_activity_recognition_for_wrist_name_lists[LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = lsm6dsk320x_activity_recognition_for_wrist_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_activity_recognition_for_wrist_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsk320x_activity_recognition_for_wrist_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsk320x_activity_recognition_for_wrist_confs[LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = lsm6dsk320x_activity_recognition_for_wrist_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_activity_recognition_for_wrist_conf_0) }
};

/* Outputs */

static const struct mems_conf_result lsm6dsk320x_activity_recognition_for_wrist_results_0_0[] = {
    { .code = 0x01, .label = "OTHER" },
    { .code = 0x04, .label = "WALK" },
    { .code = 0x08, .label = "RUN" }
};

static const struct mems_conf_output lsm6dsk320x_activity_recognition_for_wrist_outputs_0[] = {
    {
        .name = "DT1",
        ...
        .reg_addr = 0x70,
        .reg_name = "MLC1_SRC",
        .num_results = (uint8_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_activity_recognition_for_wrist_results_0_0),
        .results = lsm6dsk320x_activity_recognition_for_wrist_results_0_0
    }
};

static const struct mems_conf_output_list lsm6dsk320x_activity_recognition_for_wrist_output_lists[LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = lsm6dsk320x_activity_recognition_for_wrist_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_activity_recognition_for_wrist_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier lsm6dsk320x_activity_recognition_for_wrist_mlc_identifiers_0[] = {
...
static const struct mems_conf_mlc_identifier_list lsm6dsk320x_activity_recognition_for_wrist_mlc_identifier_lists[LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_SENSORS_NUM] = {
    { .list = lsm6dsk320x_activity_recognition_for_wrist_mlc_identifiers_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsk320x_activity_recognition_for_wrist_mlc_identifiers_0) }
};
...
#endif /* LSM6DSK320X_ACTIVITY_RECOGNITION_FOR_WRIST_H */
