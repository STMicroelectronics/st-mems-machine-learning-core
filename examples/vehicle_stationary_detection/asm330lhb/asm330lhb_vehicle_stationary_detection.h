...
#ifndef ASM330LHB_VEHICLE_STATIONARY_DETECTION_H
#define ASM330LHB_VEHICLE_STATIONARY_DETECTION_H
...
#define ASM330LHB_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM 1
...
static const char *const asm330lhb_vehicle_stationary_detection_format_version = "2.0";

static const char *const asm330lhb_vehicle_stationary_detection_description = NULL;

static const struct mems_conf_application asm330lhb_vehicle_stationary_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const asm330lhb_vehicle_stationary_detection_date = NULL;

/* Sensor names */

static const char *const asm330lhb_vehicle_stationary_detection_names_0[] = {
    "ASM330LHB"
};

static const struct mems_conf_name_list asm330lhb_vehicle_stationary_detection_name_lists[ASM330LHB_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhb_vehicle_stationary_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhb_vehicle_stationary_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op asm330lhb_vehicle_stationary_detection_conf_0[] = {
...
static const struct mems_conf_op_list asm330lhb_vehicle_stationary_detection_confs[ASM330LHB_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhb_vehicle_stationary_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(asm330lhb_vehicle_stationary_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list asm330lhb_vehicle_stationary_detection_output_lists[ASM330LHB_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list asm330lhb_vehicle_stationary_detection_mlc_identifier_lists[ASM330LHB_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ASM330LHB_VEHICLE_STATIONARY_DETECTION_H */
