...
#ifndef ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_H
#define ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_H
...
#define ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM 1
...
static const char *const asm330lhbg1_vehicle_stationary_detection_format_version = "2.0";

static const char *const asm330lhbg1_vehicle_stationary_detection_description = NULL;

static const struct mems_conf_application asm330lhbg1_vehicle_stationary_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const asm330lhbg1_vehicle_stationary_detection_date = NULL;

/* Sensor names */

static const char *const asm330lhbg1_vehicle_stationary_detection_names_0[] = {
    "ASM330LHBG1"
};

static const struct mems_conf_name_list asm330lhbg1_vehicle_stationary_detection_name_lists[ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhbg1_vehicle_stationary_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhbg1_vehicle_stationary_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op asm330lhbg1_vehicle_stationary_detection_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x39 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x28 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x3A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x3B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x10 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0x3C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x08 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xCE },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xCF },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD0 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0F },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD1 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x2A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD2 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x1B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD3 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x08 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD4 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x24 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD5 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD6 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD7 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD8 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xC9 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xD9 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x2C },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xDA },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xDB },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xDD },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xDE },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xDF },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE0 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x58 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE1 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x2D },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE2 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE3 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3A },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE4 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x08 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE5 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE6 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE7 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE8 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x75 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xE9 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x28 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xEA },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x1E },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x04 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xF3 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xF4 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x20 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xF5 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x0B },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xF6 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x02, .data = 0x09 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x08, .data = 0xF7 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x01, .data = 0x80 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x34 },
...
static const struct mems_conf_op_list asm330lhbg1_vehicle_stationary_detection_confs[ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = asm330lhbg1_vehicle_stationary_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(asm330lhbg1_vehicle_stationary_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list asm330lhbg1_vehicle_stationary_detection_output_lists[ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list asm330lhbg1_vehicle_stationary_detection_mlc_identifier_lists[ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ASM330LHBG1_VEHICLE_STATIONARY_DETECTION_H */
