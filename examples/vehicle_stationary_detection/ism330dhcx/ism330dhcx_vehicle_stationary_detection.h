...
#ifndef ISM330DHCX_VEHICLE_STATIONARY_DETECTION_H
#define ISM330DHCX_VEHICLE_STATIONARY_DETECTION_H
...
#define ISM330DHCX_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM 1
...
static const char *const ism330dhcx_vehicle_stationary_detection_format_version = "2.0";

static const char *const ism330dhcx_vehicle_stationary_detection_description = NULL;

static const struct mems_conf_application ism330dhcx_vehicle_stationary_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const ism330dhcx_vehicle_stationary_detection_date = NULL;

/* Sensor names */

static const char *const ism330dhcx_vehicle_stationary_detection_names_0[] = {
    "ism330dhcx"
};

static const struct mems_conf_name_list ism330dhcx_vehicle_stationary_detection_name_lists[ISM330DHCX_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = ism330dhcx_vehicle_stationary_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism330dhcx_vehicle_stationary_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op ism330dhcx_vehicle_stationary_detection_conf_0[] = {
...
static const struct mems_conf_op_list ism330dhcx_vehicle_stationary_detection_confs[ISM330DHCX_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = ism330dhcx_vehicle_stationary_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(ism330dhcx_vehicle_stationary_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output_list ism330dhcx_vehicle_stationary_detection_output_lists[ISM330DHCX_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list ism330dhcx_vehicle_stationary_detection_mlc_identifier_lists[ISM330DHCX_VEHICLE_STATIONARY_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ISM330DHCX_VEHICLE_STATIONARY_DETECTION_H */
